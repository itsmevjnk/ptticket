...
CREATE ROLE auth;
ALTER ROLE auth WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS ENCRYPTED PASSWORD 'ptticket_auth';
CREATE ROLE dynamic;
ALTER ROLE dynamic WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS ENCRYPTED PASSWORD 'ptticket_dynamic';
...
CREATE ROLE static;
ALTER ROLE static WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS ENCRYPTED PASSWORD 'ptticket_static';
