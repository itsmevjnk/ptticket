...
GRANT SELECT, REFERENCES ON ALL TABLES IN SCHEMA "static" TO "static";
GRANT SELECT, INSERT, UPDATE, DELETE, TRUNCATE, REFERENCES ON ALL TABLES IN SCHEMA "dynamic" TO "dynamic";

GRANT SELECT, REFERENCES ON ALL TABLES IN SCHEMA "static" TO "dynamic";
...
GRANT SELECT ON ALL TABLES IN SCHEMA "auth" TO "auth";
