...
API_ENDPOINT = 'http://ptticket-98da9e506b659c62.elb.us-east-1.amazonaws.com:3121/api/auth'
...
def lambda_handler(event, context):
    ...
    resp = http.request('GET', API_ENDPOINT, headers = {'Authorization': token})
    print(resp)
    if resp.status != 200: raise Exception('Unauthorized')
    
    principalId = f'user|{token[7:]}'
